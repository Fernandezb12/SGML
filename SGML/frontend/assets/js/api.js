let apiBaseUrl = localStorage.getItem('sgml_api_url') || 'http://localhost:3000/api';

function resolveBaseUrl() {
  return apiBaseUrl || 'http://localhost:3000/api';
}
...
export const api = {
  ...
  resetBaseUrl() {
    ...
    localStorage.setItem('sgml_api_url', apiBaseUrl);
  },
  login(credentials) {
